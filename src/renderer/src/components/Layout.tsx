            ...
            <div className="relative z-10 min-h-screen flex flex-col">
                ...
                <header className="border-b border-white/5 bg-slate-900/20 backdrop-blur-sm">
                    <div className="max-w-4xl mx-auto px-6 py-3 flex items-center gap-2.5">
                        <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-indigo-500 to-blue-600 flex items-center justify-center shadow-lg shadow-indigo-500/20">
                            <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
                            </svg>
                        </div>
                        <div>
                            <h1 className="font-bold text-base tracking-wide">ATLAS</h1>
                            <p className="text-[9px] text-slate-500 font-mono tracking-wider">KONTUR OS v2.0</p>
                        </div>
                    </div>
                </header>
